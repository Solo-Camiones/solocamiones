...
**AI Assistant (2026-09-22):** Feature 17 (`AI-001`–`AI-010`) is **documentation-confirmed** in `FEATURES/17_AI_ASSISTANT.md`. Technical sequence: `docs/chatbot_implementation/IMPLEMENTATION_PLAN.md` (**M0–M7 done locally through 2026-09-24** — OpenAI adapters, persistence, corpus/sync, tools, orchestrator, HTTP/SSE, **web panel**; M8–M9 not started; guides pending owner approval). This is a **post-stabilization pilot** for `ADMINISTRATOR` only. It **does not** amend Paso 10, Feature 16, or the first-production / environment gate.
...
| **Feature 17 AI Assistant (post-stabilization pilot)**                                                                            | **M0 docs + M1–M7 done locally (2026-09-24):** OpenAI foundations, persistence, corpus/sync, tools, orchestrator, HTTP/SSE API, **web panel** (unit + component). Guides pending owner approval. M8–M9 not started. Does **not** block first production release.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Capability `assistant` on in HTTP; launcher/panel for Administrator when API flag allows                                                                                                  | No chatbot mock; capability off                                                 |
