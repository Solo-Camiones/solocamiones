...
**AI Assistant (2026-09-22):** Feature 17 (`AI-001`–`AI-010`) is **documentation-confirmed** in `FEATURES/17_AI_ASSISTANT.md`. Technical sequence: `docs/chatbot_implementation/IMPLEMENTATION_PLAN.md` (**M0 documentation done**; M1–M9 not started). This is a **post-stabilization pilot** for `ADMINISTRATOR` only. It **does not** amend Paso 10, Feature 16, or the first-production / environment gate. Do not implement assistant runtime until pre-production stabilization work allows sequencing M1+.
...
| **Feature 17 AI Assistant (post-stabilization pilot)**                                                                            | **Docs only (M0, 2026-09-22).** Runtime API/SSE/OpenAI/tools **not started**. Does **not** block first production release.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Not started; capability `assistant` not shipped                                                                                                  | No chatbot mock planned                                                 |
