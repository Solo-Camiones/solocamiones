...
**AI Assistant (2026-09-22):** Feature 17 (`AI-001`–`AI-010`) is **documentation-confirmed** in `FEATURES/17_AI_ASSISTANT.md`. Technical sequence: `docs/chatbot_implementation/IMPLEMENTATION_PLAN.md` (**M0 documentation done**; **M1 foundations done locally 2026-09-23** — OpenAI ports/adapters/config/fakes; **M2 persistence done**; **M3 corpus/sync implemented locally 2026-09-23** — guides pending owner approval; M4–M9 not started). This is a **post-stabilization pilot** for `ADMINISTRATOR` only. It **does not** amend Paso 10, Feature 16, or the first-production / environment gate.
...
| **Feature 17 AI Assistant (post-stabilization pilot)**                                                                            | **M0 docs + M1 OpenAI foundations + M2 persistence done; M3 corpus/sync implemented locally (2026-09-23), guides pending owner approval.** API/SSE/tools/UI **not started**. Does **not** block first production release.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Not started; capability `assistant` not shipped                                                                                                  | No chatbot mock planned                                                 |
