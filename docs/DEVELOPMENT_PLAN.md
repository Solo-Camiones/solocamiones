...
**AI Assistant (2026-09-22):** Feature 17 (`AI-001`–`AI-010`) is **documentation-confirmed** in `FEATURES/17_AI_ASSISTANT.md`. Technical sequence: `docs/chatbot_implementation/IMPLEMENTATION_PLAN.md` (**M0–M6 done locally through 2026-09-24** — OpenAI adapters, persistence, corpus/sync, tools, orchestrator, HTTP/SSE; M7–M9 not started; guides pending owner approval). This is a **post-stabilization pilot** for `ADMINISTRATOR` only. It **does not** amend Paso 10, Feature 16, or the first-production / environment gate.
...
| **Feature 17 AI Assistant (post-stabilization pilot)**                                                                            | **M0 docs + M1–M6 done locally (2026-09-24):** OpenAI foundations, persistence, corpus/sync, tools, orchestrator, **HTTP/SSE API** (unit + integration). Guides pending owner approval. M7–M9 not started. Does **not** block first production release.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Not started; capability `assistant` not shipped                                                                                                  | No chatbot mock planned                                                 |
