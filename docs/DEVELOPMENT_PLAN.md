...
**AI Assistant (2026-09-22):** Feature 17 (`AI-001`–`AI-010`) is **documentation-confirmed** in `FEATURES/17_AI_ASSISTANT.md`. Technical sequence: `docs/chatbot_implementation/IMPLEMENTATION_PLAN.md` (**M0–M8 done locally through 2026-09-24**; the **M9 baseline from 2026-09-24 is superseded** after the 2026-09-25 privacy/quota/mutation-gate hardening and must repeat fake+local-real + human review; see `docs/assistant-eval/BASELINE.md`). Staging/prod enablement remains blocked by `ROLLOUT_CHECKLIST.md`. This is a **post-stabilization pilot** for `ADMINISTRATOR` only. It **does not** amend Paso 10, Feature 16, or the first-production / environment gate.
...
| **Feature 17 AI Assistant (post-stabilization pilot)**                                                                            | **M0–M8 done locally (2026-09-24); M9 revalidation pending** after 2026-09-25 hardening (`docs/assistant-eval/BASELINE.md`: prior fake+local-real baseline superseded; repeat both modes + human review). Prod enablement still gated by `ROLLOUT_CHECKLIST.md`. Does **not** block first production release.                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Capability `assistant` on in HTTP; launcher/panel for Administrator when API flag allows                                  | No chatbot mock; capability off                                                 |
