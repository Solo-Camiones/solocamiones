...
| **Feature 17 AI Assistant (post-stabilization pilot)**                                                                            | **M0 docs + M1 OpenAI foundations done locally (2026-09-23).** Persistence/API/SSE/tools/UI **not started**. Does **not** block first production release.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Not started; capability `assistant` not shipped                                                                                                  | No chatbot mock planned                                                 |
