...
- [x] Approved Markdown corpus + manifest; sync CLI; checksum/version tracking. _(Implemented 2026-09-23; the six manifest entries are `approved`, checksummed and covered by validation/sync tests. Synchronization remains an explicit per-environment operation.)_
