...
| `10_SALES_AND_INVOICES.md` | Invoice lifecycle, quotes, line types, taxes, PDF, sale confirmation | Release 2/5/7 + pre-production | **R2 done**. ITEM/QTY/installed **API not started**. Paso 2 `applyItbis`/quotes schema. **Paso 4:** SALE-009/010 tax-exclusive ITBIS + POS checkbox. Quote commands and DOC-001 PDF still later |
